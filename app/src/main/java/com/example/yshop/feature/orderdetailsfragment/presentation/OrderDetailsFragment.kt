package com.example.yshop.feature.orderdetailsfragment.presentation
...
import com.example.yshop.feature.orderdetailsfragment.domain.viewmodel.OrderDetailsViewModel
...
class OrderDetailsFragment : Fragment(), RecyclerCartListAdapter.OnClickCartList {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (arguments?.containsKey(Constants.EXTRA_MY_ORDER_DETAILS) == true) {
            mOrderDetails =
                arguments?.getSerializable(Constants.EXTRA_MY_ORDER_DETAILS) as OrderModel
        }

        orderDetailsViewModel.setUpUi(
            requireActivity(),
            mOrderDetails,
