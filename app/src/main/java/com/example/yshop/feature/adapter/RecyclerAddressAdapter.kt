...
import com.example.yshop.feature.addresslistfragment.presentation.AddressListFragment
import com.example.yshop.feature.addresslistfragment.data.model.request.AddressModel

class RecyclerAddressAdapter(
    private val dataSet: ArrayList<AddressModel>,
    var onClickAddressList: OnClickAddressList
) : RecyclerView.Adapter<RecyclerAddressAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        viewHolder.binding.tvAddressDetails.text =
            "${dataSet[position].address} , ${dataSet[position].zipCode}"
    ...
    fun notifyEditItem(fragmentAddressList: AddressListFragment, position: Int) {
        ...
        fragmentAddressList.findNavController()
            .navigate(R.id.action_addressListFragment_to_addEditAddressFragment, bundle)
