package com.example.yshop.feature.productfragment.domain.viewmodel
...
class ProductsViewModel : ViewModel() {
    ...
    fun getProductDetailsById(rv_product_items: RecyclerView, tv_no_products_found: TextView) {
        ...
        productReference.orderByChild(Constants.PRODUCT_USER_ID).equalTo(Constants.getCurrentUser())
    ...
    fun deleteProduct(productId: String, productTitle: String, context: Context) {
        ...
        alert.setPositiveButton(context.resources.getString(R.string.yes)) { dialog, which ->
            ...
            Toast.makeText(
                context,
                "${context.resources.getString(R.string.err_your_address_deleted_successfully)}${productTitle}",
                Toast.LENGTH_SHORT
            ).show()
