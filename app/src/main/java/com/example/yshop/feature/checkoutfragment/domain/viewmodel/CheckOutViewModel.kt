package com.example.yshop.feature.checkoutfragment.domain.viewmodel
...
import com.example.yshop.feature.checkoutfragment.presentation.CheckOutFragment
...
class CheckOutViewModel : ViewModel() {
    ...
    fun getCartItemList(
        ll_checkout_place_order: LinearLayout,
    ...
    private fun placeAnOrder(checkOutFragment: CheckOutFragment) {
        var mAddressDetails =
            checkOutFragment.arguments?.getSerializable(Constants.EXTRA_SELECTED_ADDRESS) as AddressModel
        ...
        checkOutFragment.findNavController()
            .navigate(R.id.action_checkOutFragment_to_dashBoardFragment)
    }
