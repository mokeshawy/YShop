package com.example.yshop.feature.soldproductfragment.domain.viewmodel
...
class SoldProductViewModel : ViewModel() {
    ...
    fun getSoldProductList(
        rv_sold_product_items: RecyclerView,
        tv_no_sold_products_found: TextView
    ) {

        soldProductReference.orderByChild(Constants.USER_ID).equalTo(Constants.getCurrentUser())
